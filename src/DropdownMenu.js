(function(){
  var ref$, filter, id, map, isEqualToObject, React, div, input, span, createFactory, createReactClass, findDOMNode, ReactCSSTransitionGroup, ReactTether, DivWrapper, OptionWrapper, cancelEvent, classNameFromObject;
  ref$ = require('prelude-ls'), filter = ref$.filter, id = ref$.id, map = ref$.map;
  isEqualToObject = require('prelude-extension').isEqualToObject;
  React = require('react'), ref$ = React.DOM, div = ref$.div, input = ref$.input, span = ref$.span, createFactory = React.createFactory;
  ...
  module.exports = createReactClass({
      ...
      if (!!this.props.transitionEnter || !!this.props.transitionLeave) {
        return ReactCSSTransitionGroup({
          ...
          ref: function(element){
            return this.dropdownMenuWrapper = element;
          }
    ...
    renderDropdown: function(arg$){
      ...
      if (this.props.open) {
        return DivWrapper({
          ...
          ref: function(element){
            return !!element && (this.dropdownMenu = element);
          },
          onHeightChange: function(height){
            if (this$.dropdownMenuWrapper) {
              findDOMNode(this$.dropdownMenuWrapper).style.height = height + "px";
            }
          }
    ...
    componentDidUpdate: function(){
      ...
      x$ = dropdownMenu = findDOMNode((ref$ = this.dropdownMenuWrapper) != null
        ? ref$
        : this.dropdownMenu);
      if (x$ != null) {
